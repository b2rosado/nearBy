...
public class HomeActivity extends Activity {
	...
	private void populateDatabase() {
		...
		restaurants.add(new Restaurant("Café da Maria", "Café", 3.5f, "9:00/22:00", 0, 0f));
		restaurants.add(new Restaurant("Café do Aires", "Café", 4.0f, "9:00/20:00", 0, 0f));
		...
		interestPoints.add(new InterestPoint("Mosteiro dos Jerónimos", "Uma obra histórica..", "Monumento", 12.0f, "10:00/19:00", 0, 0f));
		interestPoints.add(new InterestPoint("Mosteiro da Batalha", "Outra obra histórica..", "Monumento", 12.0f, "10:00/19:00", 0, 0f));
		interestPoints.add(new InterestPoint("Jardim Botânico", "A beleza natural", "Jardim", 5.0f, "10:00/18:00", 0, 0f));
		interestPoints.add(new InterestPoint("Centro Cultural de Belém", "Um sítio a visitar", "Museu", 13.0f, "9:00/21:00", 0, 0.0f));
		...
		publicTransports.add(new PublicTransport(4, "TAP-140", "Avião", 1.0f, "00:01:30"));
